    ...
    public class Program
    {
        ...
        private static void ConfigureServices(ServiceCollection services)
        {
            ...
            services.AddSingleton(typeof(SpiDevice), _ =>
            {
                ...
                var spiSettings = new SpiConnectionSettings(2, Gpio.IO18)
                {
            ...
            services.AddSingleton(typeof(Rf69), provider =>
            {
                ...
                var deviceSelectPin = gpioController.OpenPin(Gpio.IO06, PinMode.Output);
            ...
            {
                var gpioController = (GpioController)provider.GetRequiredService(typeof(GpioController));
                var resetPin = gpioController.OpenPin(Gpio.IO09, PinMode.Output);
